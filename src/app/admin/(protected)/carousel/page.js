      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "30px", background: "white", padding: "30px", borderRadius: "12px", boxShadow: "0 2px 8px rgba(0, 0, 0, 0.1)" }}>
          <div>
            ...
            <h1 style={{ fontSize: "28px", color: "#333", marginBottom: "8px" }}>Gestionar Carrusel</h1>
            <p style={{ color: "#666", fontSize: "14px" }}>Administra las imágenes del hero principal</p>
          </div>
        ...
        <div style={{ background: "white", borderRadius: "12px", padding: "30px", boxShadow: "0 2px 8px rgba(0, 0, 0, 0.1)" }}>
          <h2 style={{ fontSize: "20px", color: "#333", marginBottom: "12px" }}>📸 Imágenes del Carrusel</h2>
          <p style={{ color: "#666", fontSize: "14px", marginBottom: "20px" }}>Aquí podrás subir y organizar las imágenes que se mostrarán en el carrusel principal.</p>
